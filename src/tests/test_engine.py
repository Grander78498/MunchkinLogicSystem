...
from engine import Disjunction, Conjunction, Negation, \
                   Implication, Equivalence, \
                   LogicalEngine, Operation, Variable, \
                   CNF
...
def test_remove_implications(input: Operation, expected: Operation, engine: LogicalEngine):
...
def test_remove_equivalences(input: Operation, expected: Operation, engine: LogicalEngine):
...
def test_remove_double_negations(input: Operation, expected: Operation, engine: LogicalEngine):
...
def test_group_conjunctions(input: Operation, expected: Operation, engine: LogicalEngine):
